            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-3">
                  <h1 className="text-2xl font-bold text-white">Fit-up & welding TOP</h1>
                  <Link to="/operator/neeraj">
                    <Badge className="bg-blue-600 text-white text-sm px-3 py-1 cursor-pointer hover:bg-blue-700 transition-colors">
                        Operator: Neeraj
                    </Badge>
                  </Link>
                </div>
                <p className="text-sm text-slate-400 mt-1">Fit-up & welding TOP Line • Production Analytics Dashboard</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <Button
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-lg text-white">Fit-up & welding TOP</CardTitle>
                  <span
                    className={`text-sm ${
                      selectedPeriod === "24h"
                        ? "text-red-500"
