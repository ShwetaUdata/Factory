          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400 mt-1">Gas Cutting Line • Production Analytics Dashboard</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <Button
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-lg text-white">Gas cutting: GP-31</CardTitle>
                  <span
                    className={`text-sm ${
                      selectedPeriod === "24h"
                        ? "text-red-500"
