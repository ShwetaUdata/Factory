            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-3">
                  <h1 className="text-2xl font-bold text-white">Shot-blasting</h1>
                ...
                <p className="text-sm text-slate-400 mt-1">Shot-blasting Line • Production Analytics Dashboard</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <Button
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-lg text-white">Shot-blasting</CardTitle>
                  <span
                    className={`text-sm ${
                      selectedPeriod === "24h"
                        ? "text-red-500"
